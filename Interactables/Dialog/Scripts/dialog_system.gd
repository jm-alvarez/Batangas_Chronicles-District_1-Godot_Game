...
@onready var name_label = $DialogUI/NameLabel
@onready var dialog_progress_indicator = $DialogUI/PanelContainer/DialogProgressIndicator
@onready var portrait_sprite : DialogPortrait = $DialogUI/PortraitBG/PortraitSprite
@onready var dialog_progress_indicator_label = $DialogUI/PanelContainer/DialogProgressIndicator/Label
...
func start_dialog_cutscene( _d : DialogCutscene ) -> void:
	...
	choice_options.visible = false #gawing false if hindi mag hide
	dialog_ui.visible = true
	advance_dialog()
	pass
